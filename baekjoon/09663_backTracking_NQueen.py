...
horizontalCheck = [0] * N # - 방향(수평방향) 체크
...
def checkOK(row, column): # 그 위치에 놓을 수 있으면 True, 아니면 False
    if horizontalCheck[row] or plusDiagonalCheck[row+column] or minusDiagonalCheck[row-column+N-1]:
        return False
